...
command+="-incdir . -incdir ./dv/testbench/ -incdir ./dv/testbench/tests/ -incdir ./dv/testbench/agents/i2c_agent/ -incdir ./dv/testbench/agents/clk_agent/ -incdir ./dv/testbench/models/ -incdir ./rtl/ "
